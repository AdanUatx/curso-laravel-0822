                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label> {{ trans('forms.form_create.lastname_1') }}: {{$empleado->paterno}} </label>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label> {{ trans('forms.form_create.lastname_2') }}: {{$empleado->materno}}</label>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label> {{ trans('forms.form_create.birthdate') }}: {{$empleado->nacimiento }}</label>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>{{ trans('forms.form_create.email') }}: {{$empleado->email}}</label>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
