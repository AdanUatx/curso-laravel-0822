                        ...
                        <form method="POST" action="<?php echo e(route('empleado.update',$empleado->id)); ?>" role="form">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="paterno" id="paterno" class="form-control input-sm" placeholder="Apellido paterno del empleado" value="<?php echo e(old('paterno',$empleado->paterno)); ?>">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label><?php echo e(trans('forms.form_create.lastname_2')); ?></label>
                                        <input type="text" name="materno" id="materno" class="form-control input-sm" placeholder="Apellido materno del empleado" value="<?php echo e(old('materno',$empleado->materno)); ?>">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="nacimiento" id="nacimiento" class="form-control input-sm" value="<?php echo e(old('nacimiento',$empleado->nacimiento)); ?>">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="salario" id="salario" class="form-control input-sm" placeholder="Salario del empleado" value="<?php echo e(old('salario', $empleado->salario)); ?>">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <label class="form-control input-sm"><?php echo e($empleado->codigo_empleado); ?></label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3 col-sm-6 col-xs-12">
                                ...
                                <div class="form-check">
                                    ...
                                    <label><?php echo e(trans('forms.form_create.male')); ?></label>
                                </div>
                                <div class="form-check">
                                    ...
                                    <label><?php echo e(trans('forms.form_create.female')); ?></label>
                                </div>
                            </div>
