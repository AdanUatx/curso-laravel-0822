                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label><?php echo e(trans('forms.form_create.code')); ?>: <?php echo e($empleado->codigo_empleado); ?></label>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label> <?php echo e(trans('forms.form_create.lastname_1')); ?>: <?php echo e($empleado->paterno); ?> </label>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label> <?php echo e(trans('forms.form_create.lastname_2')); ?>: <?php echo e($empleado->materno); ?></label>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label> <?php echo e(trans('forms.form_create.birthdate')); ?>: <?php echo e($empleado->nacimiento); ?></label>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label><?php echo e(trans('forms.form_create.email')); ?>: <?php echo e($empleado->email); ?></label>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label><?php echo e(trans('forms.form_create.telephone')); ?>: <?php echo e($empleado->telefono); ?></label>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-lg-1">
                                <a href="<?php echo e(route('empleado.index')); ?>" class="btn btn-default btn-sm">Atras</a>
                            </div>
                        </div>
